...
def register_callbacks(app):
    ...
    def update_segmentation_graph(selected_years, selected_months):
        return update_graph(selected_years, selected_months)
    ...
    def update_second(selected_years, selected_months):
        return update_second_graph(selected_years, selected_months)
    ...
    def update_ca_graph(selected_years, selected_months):
        return update_third_graph(selected_years, selected_months)
